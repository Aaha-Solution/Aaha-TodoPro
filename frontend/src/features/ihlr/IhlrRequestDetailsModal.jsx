...
const IhlrRequestDetailsModal = ({ isOpen, request, onClose, onEditMode }) => {
  ...
  return (
    <>
      ...
      {/* Export Format Selection Modal for this Single Report */}
      {showExportModal && (
        <div 
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-extrabold text-slate-900 tracking-tight">
                    Export Report {String(request.req_no || '').startsWith('IHLR-') ? request.req_no : `#${request.req_no}`}
                  </h3>
                  <p className="text-xs text-slate-500 mt-0.5">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Download complete structured investigation sheet with defect details, 5-Why root-causes, and containment actions.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Official print-ready PDF analysis report with India Nippon Electricals Limited branding, tables, and signatures.
                  </p>
                </div>
              </div>
            </div>
